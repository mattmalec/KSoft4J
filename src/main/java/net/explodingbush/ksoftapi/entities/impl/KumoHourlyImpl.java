...
public class KumoHourlyImpl extends KumoImpl implements KumoWeather {
    @Override
    ...
    public List<KumoWeather> getAll() {
        ...
        for(Object o : json.getJSONObject("data").getJSONArray("by_hour")) {
            KumoWeather hourly = new KumoHourlyImpl(new JSONObject(o.toString()));
    ...
    public KumoHourlyImpl(JSONObject json) {
